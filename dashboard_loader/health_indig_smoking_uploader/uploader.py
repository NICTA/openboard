...
from health_indig_smoking_uploader.models import *
...
def upload_file(uploader, fh, actual_freq_display=None, verbosity=0):
    ...
    try:
        ...
        messages.extend(
                update_graph_data(
                            "indig_smoking-health-hero", "indig_smoking-health-hero",  
                            "health-indig_smoking-hero-graph",
                            HealthIndigenousSmokingData, "percentage",
                            [ AUS, ],
                            benchmark_start=2008,
                            benchmark_end=2018,
                            benchmark_gen=lambda init: init / Decimal(2),
        ...
        messages.extend(
                update_graph_data(
                            "health_indig_smoking", "health_indig_smoking",  
                            "health_indig_smoking_summary_graph",
                            HealthIndigenousSmokingData, "percentage",
                            [ AUS, ],
                            benchmark_start=2008,
                            benchmark_end=2018,
        ...
        messages.extend(
                update_graph_data(
                            "health_indig_smoking", "health_indig_smoking",  
                            "health_indig_smoking_detail_graph",
                            HealthIndigenousSmokingData, "percentage",
                            benchmark_start=2008,
                            benchmark_end=2018,
                            benchmark_gen=lambda init: init / Decimal(2),
