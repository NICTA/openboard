...
urlpatterns = [
    ...
    url(r'^widgets/(?P<widget_url>[^/]+)/(?P<label>[^/]+)$', views.ViewWidgetView.as_view(), name="view_widget_data"),
    url(r'^parametised_widgets/(?P<widget_url>[^/]+)/(?P<label>[^/]+)/(?P<pval_id>[^/]+)$', views.ViewWidgetView.as_view(), name="view_parametised_widget_data"),
