...
from health_childhealthyweight_uploader.models import *
...
def upload_file(uploader, fh, actual_freq_display=None, verbosity=0):
    ...
    try:
        ...
        messages.extend(
                update_graph_data(
                            "childweight-health-hero", "childweight-health-hero",  
                            "health-childweight-hero-graph",
                            HealthChildHealthyWeightData, "percentage",
                            [ AUS, ],
        ...
        messages.extend(
                update_graph_data(
                            "health_childweight", "health_childweight",  
                            "health_childweight_summary_graph",
                            HealthChildHealthyWeightData, "percentage",
                            [ AUS, ],
                            benchmark_start=2008,
                            benchmark_end=2018,
        ...
        messages.extend(
                update_graph_data(
                            "health_childweight", "health_childweight",  
                            "health_childweight_detail_graph",
                            HealthChildHealthyWeightData, "percentage",
                            benchmark_start=2008,
                            benchmark_end=2018,
                            benchmark_gen=lambda init: Decimal(5)+init,
