...
Django 1.8  (http://www.djangoproject.com)
	...
	An open source MVC based web application framework written in 
	Python.
...
An uploader.py file must define:
	...
	upload_file:
		...
		uploader: A dashboard_loader.models.Uploader instance.
		fh: A file handle to the uploaded data file.
		actual_freq_display=None: An optional value to update
			the actual_frequency_display value to, for the
			affected widgets.
		verbosity=0: logging verbosity, as used by manage.py commands.
